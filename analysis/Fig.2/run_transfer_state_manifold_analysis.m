...
subplot(2,3,2)
for k=51:51
    h1=plot(score((k-1)*500+1:k*500,1),score((k-1)*500+1:k*500,2),'g');
    hold on
end
set(gca,'fontsize',10)
xlabel('PC2')
...
subplot(2,3,3)
for k=101:101
    h1=plot(score((k-1)*500+1:k*500,1),score((k-1)*500+1:k*500,2),'b');
    hold on
end
set(gca,'fontsize',10)
xlabel('PC2')
...
subplot(2,3,4)
for k=161:161
    h1=plot(score((k-1)*500+1:k*500,1),score((k-1)*500+1:k*500,2),'m');
    hold on
end
set(gca,'fontsize',10)
xlabel('PC2')
...
subplot(2,3,5)
for k=239:239
    h1=plot(score((k-1)*500+1:k*500,1),score((k-1)*500+1:k*500,2),'k');
    hold on
end
set(gca,'fontsize',10)
xlabel('PC2')
