...
for i=1:20
    disp(i)
    data_1_new = load(['F:\manifold_datasets\\walk_actor_12_summary\',filename_1{i},'.mat']);
    data_1_new=data_1_new.score;
    data_2_new = load(['F:\manifold_datasets\\walk_actor_512_summary\',filename_1{i},'.mat']);
    data_2_new=data_2_new.score;
    data_3_new = load(['F:\manifold_datasets\\walk_state_1536_summary\',filename_1{i},'.mat']);
    data_3_new=data_3_new.score;
    pc_matrix=[];
    for k=1:239
...
for i=1:20
    disp(i)
    data_1_new = load(['F:\manifold_datasets\\run_actor_12_summary\',filename_1{i},'.mat']);
    data_1_new=data_1_new.score;
    data_2_new = load(['F:\manifold_datasets\\run_actor_512_summary\',filename_1{i},'.mat']);
    data_2_new=data_2_new.score;
    pc_matrix=[];
    for k=1:239
...
for i=1:20
    disp(i)
    data_1_new = load(['F:\manifold_datasets\\run_transfer_actor_12_summary\',filename_1{i},'.mat']);
    data_1_new=data_1_new.score;
    data_2_new = load(['F:\\manifold_datasets\\run_transfer_actor_512_summary\',filename_1{i},'.mat']);
    data_2_new=data_2_new.score;
    pc_matrix=[];
    for k=1:239
...
for k = 1:length(walk_correlation_matrix)
    ...
    now = squeeze(mean(now([1,3],[1,2,3],:),1));
