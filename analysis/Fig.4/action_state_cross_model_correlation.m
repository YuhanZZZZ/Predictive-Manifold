...
for i=1:20
    disp(i)
    data_1_new = load(['D:\matlab 2021\matlab_program\manifold_datasets\walk_actor_12_summary\',filename_1{i},'.mat']);
    data_1_new=data_1_new.score;
    data_2_new = load(['D:\matlab 2021\matlab_program\manifold_datasets\walk_state_1536_summary\',filename_1{i},'.mat']);
...
for i=1:20
    disp(i)
    data_1_new = load(['D:\matlab 2021\matlab_program\manifold_datasets\run_actor_12_summary\',filename_1{i},'.mat']);
    data_1_new=data_1_new.score;
    data_2_new = load(['D:\matlab 2021\matlab_program\manifold_datasets\run_state_1536_summary\',filename_1{i},'.mat']);
    data_2_new=data_2_new.score;
    pc_matrix=[];
    for k=1:239
...
for i=1:20
    disp(i)
    data_1_new = load(['D:\matlab 2021\matlab_program\manifold_datasets\run_transfer_actor_12_summary\',filename_1{i},'.mat']);
    data_1_new=data_1_new.score;
    data_2_new = load(['D:\matlab 2021\matlab_program\manifold_datasets\run_transfer_state_1536_summary\',filename_1{i},'.mat']);
    data_2_new=data_2_new.score;
    pc_matrix=[];
    for k=1:239
...
for k = 1:length(walk_correlation_matrix)
    ...
    now = squeeze(mean(now([1,2,3],[1,2,3],:),1));
...
mean_value_run(1:10) = mean_value_run(1:10)-0.05;
