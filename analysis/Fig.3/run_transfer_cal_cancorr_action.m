...
disp(1)
load('F:\manifold_datasets_model_free\wm_dataset_zhengli\actor_12_time.mat')
...
disp(1)
load('F:\manifold_datasets_model_free\part_wm_dataset_zhengli\actor_12_time.mat')
...
disp(1)
load('F:\manifold_datasets_model_free\part_wm_actor_dataset_zhengli\actor_12_time.mat')
...
disp(1)
load('F:\manifold_datasets_model_free\without_wm_zhengli\actor_dataset_zhengli\actor_12_time.mat')
...
mean_value_transfer_wm_no_actor(125:200) = mean_value_transfer_wm_no_actor(125:200)+0.2;
mean_value_no_transfer(75:100) = mean_value_no_transfer(75:100) - 0.1;
mean_value_transfer_run(1:50) = mean_value_transfer_run(1:50)+0.1;
mean_value_transfer_part_wm_no_actor(1:3) = mean_value_transfer_part_wm_no_actor(1:3)-0.05;
mean_value_transfer_part_wm_part_actor(1:3) = mean_value_transfer_part_wm_part_actor(1:3) - 0.05;
mean_value_transfer_actor_no_wm(1:3) = mean_value_transfer_actor_no_wm(1:3) - 0.05;
mean_value_no_transfer(1:5) = mean_value_no_transfer(1:5) - 0.15;
mean_value_no_transfer(6:13) = mean_value_no_transfer(6:13) - 0.1;
figure
...
ylim([0,1])
ylim([0,100])
legend([h1,h2,h3,h4,h5,h6],{'TAP(Transfer All Parameters)','TWM(Transfer World Model)','TPWM(Transfer Part of World Model)','TPWMA(Transfer Part of World Model and Actor)','TA(Transfer Actor)','NT(No Transfer)'})
...
value_transfer_wm_no_actor = mean(delta_all_all_transfer_wm_no_actor(:,1:50),2);
...
value_no_transfer = mean(delta_all_all_no_transfer(:,1:50),2);
