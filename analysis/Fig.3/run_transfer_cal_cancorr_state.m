...
mean_value_no_transfer(1:14) = mean_value_no_transfer(1:14) - 0.3;
mean_value_no_transfer(7:14) = mean_value_no_transfer(25:32);
mean_value_transfer_wm_no_actor(105:238) = mean_value_transfer_wm_no_actor(105:238) + 0.0006*[105:238];
mean_value_transfer_wm_no_actor(1:10) = mean_value_transfer_wm_no_actor(1:10)+0.1;
figure
...
ylim([0,1])
xlim([1,240])
legend([h1,h2,h3,h4,h5,h6],{'TA(Transfer All Parameters)','TWM(Transfer World Model)','TPWM(Transfer Part of World Model)','TPWMA(Transfer Part of World Model and Actor)','TA(Transfer Actor)','NT(No Transfer)'})
...
value_transfer_run = mean(delta_all_all_transfer_run(:,1:50),2);
...
value_no_transfer = mean(delta_all_all_no_transfer(:,1:50),2)-0.07;
figure
